...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.7.1

* [7.7 clean backport or #11737] simplify batch classes, do not compute JE empty batches, refactor RE worker loop https://github.com/elastic/logstash/pull/11747[#11747]
* performance: share a single secret store (7.7. backport of #10794) https://github.com/elastic/logstash/pull/11772[#11772]
* [7.7] bump elasticsearch output dependency to 10.4.2 https://github.com/elastic/logstash/pull/11832[#11832]

=== Logstash Commits between 7.7 and 7.7.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.7.0..7.7"

5f9784748 - (HEAD -> 7.7, upstream/7.7) Quieten down kafka teardown script (2 weeks ago) <Rob Bavey>
001866cdd - Doc:Replace cloud trial notice with attribute (2 weeks ago) <Karen Metts>
556498e35 - tools convert to batch files (#11753) (#11901) (2 weeks ago) <Rob Bavey>
d11d472d3 - Update JrJackson and Jackson Databind versions (#11902) (2 weeks ago) <Rob Bavey>
9caa2ee13 - merge (3 weeks ago) <Robert Bavey>
0fd76b4d4 - merge (3 weeks ago) <Robert Bavey>
41a8c6dfe - merge (3 weeks ago) <Robert Bavey>
a23e72078 - merge (3 weeks ago) <Robert Bavey>
666d12cae - bump to 7.7.1 (3 weeks ago) <Joao Duarte>
5bc23672c - download kafka from another mirror (3 weeks ago) <Joao Duarte>
098aa3eec - remove plugin internal validation call (6 weeks ago) <Colin Surprenant>
be1690838 - Fix: cloud_id not propagating from monitoring config (6 weeks ago) <Karol Bucek>
56a9818c8 - bump elasticsearch output dependency to 10.4.2 (6 weeks ago) <Colin Surprenant>
9f8843f39 - performance: share a single secret store (8 weeks ago) <Ry Biesemeyer>
9d2aa5cde - simplify batch classes, do not compute JE empty batches, refactor RE worker loop (9 weeks ago) <Colin Surprenant>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.7.0..7.7 *.release"
Changed plugin versions:
logstash-output-elasticsearch: 10.3.3 -> 10.4.2
---------- DELETE UP TO HERE ------------
