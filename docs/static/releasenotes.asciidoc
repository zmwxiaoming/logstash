...
=== Logstash Commits between 7.7.1 and 7.7.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.7.0..7.7.1"

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.7.0..7.7.1 *.release"
